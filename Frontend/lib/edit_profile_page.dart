...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Future<void> _fetchUserProfile() async {
    ...
    final url = Uri.parse('https://animation-phoenix-crevice.ngrok-free.dev/api/user/get_info/${widget.studentID}');//API 23 Get user new info 
  ...
  Future<void> registerUser() async {
    ...
    final url = Uri.parse('https://animation-phoenix-crevice.ngrok-free.dev/api/user/update_info');//API 21: Update user profile
